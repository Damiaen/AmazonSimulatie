...
window.onload = function () {
    ...
    function importModel(name, size = 400, xpos = 0, ypos = 0, zpos = 0, rotation = 0) {
    ...
    function init() {
        ...
        audioLoader.load( 'sound/background_music.ogg', function( buffer ) {
        ...
        /*
                        ...
                        scene.add(plane);
        */
        importModel("floating_island",1,0,0.5,0,0);
